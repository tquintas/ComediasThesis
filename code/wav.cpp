...
namespace WAV
{
    WAVE::WAVE(short* buff, int number_of_samples)
    {
        Buffer = buff;
        NumberSamples = number_of_samples;
    }
    void WAVE::Save(const char* file_name = "WaveFile.wav", int sample_rate = 44100, short bits_per_sample = 16, short number_of_channels = 1)
    {
