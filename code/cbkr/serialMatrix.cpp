...
namespace SerialMatrix
{
    ...
    double NOTE_VALUE::duration(double beat_length, double tuple)
    {
    ...
    void Melody::AddNote(double pitch, double amp, double beat_length, double tuple)
    {
    ...
    void Melody::ToWAV(const char* file_name)
    {
        short* buff = Buffer();
    ...
    void Melody::Convolve(std::vector<Melody*> melodies, const char* file_name)
    {
