...
namespace bkr
{
    ...
    class XTuning : public XPreparation
    {
        ...
        public:
            ...
            void RandomCustomSpringScale(double mean, double std_dev);
            ...
            void RandomAbsoluteOffsets(int n, double key_mean, double key_stddev, double off_mean, double off_stddev);
            ...
            void RandomTethers(int n, double key_mean, double key_stddev, double tth_mean, double tth_stddev);
            ...
            void RandomSprings(double mean, double std_dev);
